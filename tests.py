...
data = U.urlopen("https://www.youtube.com/results?search_query=peppa")
soup = bs.BeautifulSoup(data, "lxml")

for i in soup.body.find_all("a", class_= "yt-uix-tile-link yt-ui-ellipsis yt-ui-ellipsis-2 yt-uix-sessionlink spf-link "):
    titles.append(i.get("title"))
    IDs.append(i.get("href"))

for i in soup.body.find_all("span", class_= "video-time"):
    duration.append(i.text)

#for i in range(0, len(titles)):
    #print("Título: " + titles[i],
            #"Duración: " + duration[i],
            #"ID: " + IDs[i], "\n")
print(titles)
print(duration)
